go-chart
========
[![CircleCI](https://circleci.com/gh/wcharczuk/go-chart.svg?style=svg)](https://circleci.com/gh/wcharczuk/go-chart) [![Go Report Card](https://goreportcard.com/badge/github.com/ClarkKenty/go-chart)](https://goreportcard.com/report/github.com/ClarkKenty/go-chart)
...
```bash
> go get -u github.com/ClarkKenty/go-chart
```
...
import (
    ...
    "bytes"
    ...
    "github.com/ClarkKenty/go-chart" //exposes "chart"
)
